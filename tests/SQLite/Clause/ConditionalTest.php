...
class ConditionalTest extends TestCase
{
    ...
    {
        $subject = new SQLite\Clause\Conditional('col', '=', 'val');
    ...
    {
        $subject = new SQLite\Clause\Conditional('col', 'IN', [1, 2, 3]);
    ...
    {
        $subject = new SQLite\Clause\Conditional('col', 'IN', []);
    ...
    {
        $subject = new SQLite\Clause\Conditional('col', 'BETWEEN', [1, 2]);
    ...
    {
        $subject = new SQLite\Clause\Conditional('col', 'BETWEEN', [1, 2, 3]);
    ...
    {
        $subject = new SQLite\Clause\Conditional('col', '=', new SQLite\Clause\Raw(1));
    ...
    {
        $subject = new SQLite\Clause\Conditional('col', '=', new SQLite\Clause\Method('test', 1, 2));
